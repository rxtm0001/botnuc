...
#define MAX_RPM_RATIO 0.4                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO          
#define MOTOR_OPERATING_VOLTAGE 9          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 7          // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 6.5     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 870              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 870              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 870              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 870              // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.080                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.150            // distance between left and right wheels
